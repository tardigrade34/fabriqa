...
import {
  ...
  benefitIcon3,
  benefitIcon4,
  brainwave-symbol-whitege2,
  brainwave-symbol-whitege3,
  brainwave-symbol-whitege4,
  brainwave-symbol-whitege5,
  brainwave-symbol-whitege6,
  brainwave-symbol-whitege7,
  chromecast,
  disc02,
  discord,
  discordBlack,
...
export const benefits = [
  {
    ...
    imageUrl: brainwave-symbol-whitege2,
  },
  {
    id: "1",
...
const Roadmap = () => (
  <Section className="overflow-hidden" id="roadmap">
    <div className="container md:pb-10">
      <Heading tag="Geleceğe Hazır Olun!" title="Sıradaki yenilikler neler?" />
